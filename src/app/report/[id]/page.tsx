      ...
      <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              <div className="mb-6">
                ...
                <p className={\	ext-2xl font-bold \\}>{riskLevel}风险</p>
              </div>

              <div className="grid grid-cols-3 gap-4">
                <div className={\\ rounded-xl p-4 text-center\}>
                  <div className={\	ext-3xl font-bold \\}>{reportData.summary?.high_risk_count || 0}</div>
              ...
              <div className="mt-6 flex flex-wrap gap-4 text-sm text-gray-500">
                ...
                {reportData.metadata?.word_count && <span>✏️ {reportData.metadata.word_count} 字</span>}
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
          <p className="text-sm text-blue-800">
            <strong>⚠️ 免责声明：</strong> 本分析仅提供风险提示参考，不构成法律意见。
            如有疑问请咨询专业律师。
          </p>
        </div>

        <div className="bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-xl font-bold mb-6">🛡️ 风险详情 ({issues.length} 项)</h2>
                ...
                return (
                  <div key={idx} className="border border-gray-200 rounded-xl p-5 hover:shadow-md transition-shadow">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <span className={\px-3 py-1 rounded-full text-sm font-medium \ \\}>{sev.label}</span>
                    </div>
        ...
        <footer className="p-6 text-center text-gray-500 text-sm mt-6">
          ...
          <p className="mt-2">Powered by AI · contractmind.xyz</p>
        </footer>
      </div>
    </main>
  );
